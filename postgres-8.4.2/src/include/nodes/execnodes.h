...
typedef struct ApproxTopEntry
{
	MinimalTuple tuple;  	/* The Tuple */
        uint32 count; 		//used for frequency
...
typedef struct AggState
{
	...
	ApproxTopEntry** topKArray;			/* Our data struture holding topKQueries*/
        int arraySize;
        int lowestEntryIndex;				/*Need these to drop replace the lowest entry*/
        uint32 lowestEntryCount;			//""""""""""""""""""""""""""""""""""""""""""""/
        cmsketch *sketch;
        int k;
	int currentIter;
