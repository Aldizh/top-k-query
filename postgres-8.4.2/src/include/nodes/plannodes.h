...
typedef enum AggStrategy
{
	...
	AGG_HASHED_APPROX			/* grouped agg, count-min sketch, approximate (NB186) */
} AggStrategy;
...
typedef struct Agg
{
	...
	Oid		*grpOperators;		/* equality operators to compare with */
	long		numGroups;		/* estimated number of groups in input */
	int		approx_nkeep;		/* NB186: max number of tuples to produce */
	int		cm_width;		/* NB186: width of count-min sketch */
	int         	cm_depth;		/* NB186: depth of count-min sketch */
} Agg;
